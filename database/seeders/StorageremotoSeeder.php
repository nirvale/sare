...
class StorageremotoSeeder extends Seeder
{
    ...
    {
      $storageremoto = Storageremoto::create(['storageremoto' => 'ORACLE ODA-X5','cve_tecremotadisco' => '3','cve_mhardware' => '1','cve_datacenter' => '2', 'capacidad' => '190000','usado' => '1560','usadop' => '55.45']);
