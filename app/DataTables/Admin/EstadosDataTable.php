    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
      return (new EloquentDataTable($query))
          ->addColumn('action',function(Estado $estado){
              $actionBtn = '
                            <a href="'.route('estado.destroy', $estado).'" id="eliminarestado" class="text-danger"><i class="fas fa-times-circle"></i></a> '
              ;
            return $actionBtn;
            })
          ->setRowId('id')
          // ->editColumn('action', function (Estado $estado) {
          //     return '<a href="'.route('usuario.show', $estado).'" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a>';
          // })
          ;
    }
