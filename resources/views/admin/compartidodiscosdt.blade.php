...
@endsection
@section('title', 'DISCOS COMPARTIDOS')
...
@section('content_header')
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-subtitle"> <i class="fas fa-puzzle-piece"></i> Módulo de Catálogos - Discos Compartidos </h4>
    </div>
  </div>
@stop
...
@section('content')
      ...
      <div id="modales" class="modales">
        ...
        <div class="modalesCrear">
          ...
          <x-admin.modal70
            idModal=compartidodiscos
            iconoNombreModal="fas fa-puzzle-piece"
            nombreModal="Agregar Disco Compartido"
          >
