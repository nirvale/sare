...
@endsection
@section('title', 'SERVIDORES DE NOMBRE DE DOMINIO')
...
@section('content_header')
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-subtitle"> <i class="fas fa-puzzle-piece"></i> Módulo de Catálogos - Servidores DNS </h4>
    </div>
  </div>
@stop
