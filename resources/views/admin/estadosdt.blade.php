...
@endsection
@section('title', 'ESTADOS DE OPERACIÓN')
...
@section('content_header')
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-subtitle"> <i class="fas fa-puzzle-piece"></i> Módulo de Catálogos - Estados de Objeto de Operación </h4>
    </div>
  </div>
@stop
