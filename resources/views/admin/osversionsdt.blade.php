...
@endsection
@section('title', 'VERSIONES DE SISTEMAS OPERATIVOS')
...
@section('content_header')
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-subtitle"> <i class="fas fa-building"></i> Módulo de Catálogos - Versiones de Sistemas Operativos </h4>
    </div>
  </div>
@stop
      ...
      <div id="modales" class="modales">
        ...
        <div class="modalesCrear">
          ...
          <x-admin.modal70
            ...
            nombreModal="Agregar Versión de sistema Operativo"
          >
