...
@endsection
@section('title', 'ESTADO DE ESQUEMAS DE BD')
...
@section('content_header')
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-subtitle"> <i class="fas fa-puzzle-piece"></i> Módulo de Catálogos - Estado de los Esquemas de Base de Datos </h4>
    </div>
  </div>
@stop
...
@section('content')
      ...
      <div id="modales" class="modales">
        ...
        <div class="modalesCrear">
          ...
          <x-admin.modal70
            idModal=estadoesquemas
            iconoNombreModal="fas fa-puzzle-piece"
            nombreModal="Agregar Estado de los Esquems"
          >
