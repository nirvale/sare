...
@endsection
@section('title', 'INTERFACES DE RED')
...
@section('content_header')
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-subtitle"> <i class="fas fa-puzzle-piece"></i> Módulo de Catálogos - Interfaces de Red </h4>
    </div>
  </div>
@stop
      ...
      <div id="modales" class="modales">
        ...
        <div class="modalesCrear">
          ...
          <x-admin.modal70
            ...
            nombreModal="Agregar Interface de Red"
          >
