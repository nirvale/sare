...
@endsection
@section('title', 'TIPO DE ALMACENAMIENTO')
...
@section('content_header')
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-subtitle"> <i class="fas fa-puzzle-piece"></i> Módulo de Catálogos - Tipos de Almacenamiento </h4>
    </div>
  </div>
@stop
      ...
      <div id="modales" class="modales">
        ...
        <div class="modalesCrear">
          ...
          <x-admin.modal70
            ...
            nombreModal="Agregar Tipo de Disco"
          >
