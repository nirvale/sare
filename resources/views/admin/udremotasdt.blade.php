...
@endsection
@section('title', 'UTILIDADES DE DISCO REMOTO')
...
@section('content_header')
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-subtitle"> <i class="fas fa-puzzle-piece"></i> Módulo de Catálogos - Herramienta para Disco Remoto </h4>
    </div>
  </div>
@stop
