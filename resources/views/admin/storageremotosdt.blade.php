...
@section('content_header')
  <div class="card">
    ...
    <div class="card-body">
      <h4 class="card-subtitle"> <i class="fas fa-building"></i> Módulo de Catálogos - Sistemas de Almacenamiento Remoto</h4>
    </div>
  </div>
@stop
...
@section('content')
      ...
      <div id="modales" class="modales">
        ...
        <div class="modalesCrear">
          ...
          <x-admin.modal70
            idModal=storageremotos
            iconoNombreModal="fas fa-building"
            nombreModal="Agregar Sistema de Almacenamiento Remoto"
          >
